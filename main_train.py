...
from networks.LKDA_net.network_backbone import LKDA_Net
...
parser.add_argument('--output', type=str, default='/mnt/public/home/220462/LKDA_net/output',  help='Output folder for both tensorboard and the best model')
parser.add_argument('--dataset', type=str, default='synapse',   help='Datasets: {synapse,brats,feta, flare, amos}, Fyi: You can add your dataset here')

## Input model & training hyperparameters
parser.add_argument('--network', type=str, default='LKDA_net', help='Network models: {TransBTS, nnFormer, UNETR, SwinUNETR, LKDA_net}')
